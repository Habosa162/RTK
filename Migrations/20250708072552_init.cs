    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerCredit", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerCredit_Customers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RetailTransactions", x => x.TransactionId);
                    table.ForeignKey(
                        name: "FK_RetailTransactions_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "CustomerId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RetailTransactionId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "OrderId");
                    table.ForeignKey(
                        name: "FK_Payment_RetailTransactions_RetailTransactionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RetailTransactionItems", x => x.TransactionItemId);
                    table.ForeignKey(
                        name: "FK_RetailTransactionItems_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RetailTransactionItems_RetailTransactions_TransactionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShippingDetails_ShippingAddresses_AddressId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerCredit_CustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payment_RetailTransactionId",
                table: "Payment",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RetailTransactionItems_ProductId",
                table: "RetailTransactionItems",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_RetailTransactionItems_TransactionId",
                table: "RetailTransactionItems",
                column: "TransactionId");

            migrationBuilder.CreateIndex(
                name: "IX_RetailTransactions_CustomerId",
